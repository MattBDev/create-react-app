...
import { getLinesAround } from './getLinesAround.ts';
 ...
 * @param fileUri The URI of the <code>bundle.js</code> file.
 * @param frames A set of <code>StackFrame</code>s which are already mapped and missing their generated positions.
 * @param contextLines The number of lines to provide before and after the line specified in the <code>StackFrame</code>.
 */
